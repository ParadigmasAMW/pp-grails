	...
	<body>
		...
		<div id="show-commentator" class="content scaffold-show" role="main">
			...
			<ol class="property-list commentator">
				...
				<g:if test="${commentatorInstance?.url}">
				<li class="fieldcontain">
					<span id="url-label" class="property-label"><g:message code="commentator.url.label" default="Url" /></span>
					
						<span class="property-value" aria-labelledby="url-label"><g:fieldValue bean="${commentatorInstance}" field="url"/></span>
				...
				<g:if test="${commentatorInstance?.comment}">
				<li class="fieldcontain">
					<span id="comment-label" class="property-label"><g:message code="commentator.comment.label" default="Comment" /></span>
					
						<span class="property-value" aria-labelledby="comment-label"><g:link controller="comment" action="show" id="${commentatorInstance?.comment?.id}">${commentatorInstance?.comment?.encodeAsHTML()}</g:link></span>
