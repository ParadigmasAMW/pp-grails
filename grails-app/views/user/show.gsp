	...
	<body>
		...
		<div id="show-user" class="content scaffold-show" role="main">
			...
			<ol class="property-list user">
				...
				<g:if test="${userInstance?.githubUser}">
				<li class="fieldcontain">
					<span id="githubUser-label" class="property-label"><g:message code="user.githubUser.label" default="Github User" /></span>
					
						<span class="property-value" aria-labelledby="githubUser-label"><g:fieldValue bean="${userInstance}" field="githubUser"/></span>
